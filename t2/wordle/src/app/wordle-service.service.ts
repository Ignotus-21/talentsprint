...
// Update JSON imports to be compatible with newer Angular
import mockGuessResponsesSuccess from './mockGuessResponsesSuccess.json';
import mockGuessResponsesFailure from './mockGuessResponsesFailure.json';
import mockRegisterResponse from './mockRegisterResponse.json';
import mockCreateResponse from './mockCreateResponse.json';
